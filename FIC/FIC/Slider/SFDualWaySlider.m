...
//        [_minIndicateView setTitle:self.getMinTitle(_currentMinValue)];
        [_minIndicateView setTitle:[self getStringWithFloat:_currentMaxValue]];
    }
...
//    NSString *str = [NSString stringWithFormat:@"%.5f",value];
    NSString *str = @"";
    return str;
}
...
//            else if (point.x >= ( _maxValue * (_progressWidth - _blockSpace))){
//                x = _maxValue * (_progressWidth - _blockSpace);
//            }
            else{
